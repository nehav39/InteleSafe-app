package app.intelehealth.covid.activities.familyHistoryActivity;
...
import app.intelehealth.covid.activities.physcialExamActivity.CustomExpandableListAdapter;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(app.intelehealth.covid.utilities.StringUtils.getValue(value));
