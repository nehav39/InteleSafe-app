package app.intelehealth.covid.activities.physcialExamActivity;
...
import app.intelehealth.covid.knowledgeEngine.PhysicalExam;
...
public class PhysicalExamActivity extends AppCompatActivity {
    ...
    String mFileName_2 = "physExam_2.json";
