package org.intelehealth.swasthyasamparkp.activities.familyHistoryActivity;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.swasthyasamparkp.utilities.StringUtils.getValue(value));
