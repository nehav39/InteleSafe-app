package org.intelehealth.swasthyasamparkp.activities.privacyNoticeActivity;
...
//        spannable = boldSize(spannable, privacy_string, "Use"); //in this project's (SSampark) privacy notice we dont need "Use" in bold
